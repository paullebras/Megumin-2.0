...
const name = 'savelist';
const description = 'Génère un fichier CSV avec les données de la playlist YouTube spécifiée.';
...
module.exports = {
    ...
    async execute(interaction, args) {
        ...
        const youtubeResponse = await youtubeService.searchYoutubePlaylist(playlistId);
