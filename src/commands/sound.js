...
const name = 'sound';
const description = 'Joue un audio spécifique ou bien en choisis un aléatoirement';
const inputDescription = '<nom de l\'audio> ou \'random\' pour jouer un son aléatoire';
