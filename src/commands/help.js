...
const name = 'help';
const description = 'Affiche la description et l\'usage d\'une commande spécifique ou liste toutes les commandes.';
...
module.exports = {
    ...
    async execute(interaction, args) {
        ...
        if (args.length) {
            const requiredCommand = interaction.client.commands.find((cmd) => cmd.name === args[0]);
